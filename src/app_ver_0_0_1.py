...
stroke_color = col3.color_picker("Stroke color hex: ")
bg_color = col3.color_picker("Background color hex: ", "#eee")
bg_image = col1.file_uploader("Background image:", type=["png", "jpg"]) # Will be removed and the background image is going to be forced to be the one from the data.
